...
const en = {
  ...
  reset: {
    ...
    done: "Password reset — signing you in…",
...
const es: Dict = {
  ...
  auth: {
    ...
    resetSent: "Si ese correo existe, el enlace va en camino.",
  ...
  reset: {
    ...
    submit: "Fijar nueva contraseña",
    done: "Contraseña restablecida — iniciando sesión…",
    invalid: "Este enlace no es válido o expiró.",
  },
  shelfStatus: {
    label: "Estante: —",
